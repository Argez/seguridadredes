...
class Codevz_Core_Strings {
	...
	public static function get( $string, $sprintf = '' ) {
		...
		$strings = [
			...
			'thanks_installing_plugin' 	=> esc_html__( 'Installing theme plugin', 'xtra' ),
			...
			'activation_help' 		=> esc_html__( 'Activation Help', 'xtra' ),
			'english_version' 		=> esc_html__( 'English version?', 'xtra' ),
