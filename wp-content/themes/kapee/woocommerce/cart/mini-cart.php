						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							>
								<?php
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											...
											esc_attr( sprintf( __( 'Remove %s from cart', 'kapee' ), wp_strip_all_tags( $product_name ) ) ),
											esc_attr( $product_id ),
								...
								<div class="mini-cart-item-content">
									...
									<?php
									if( kapee_get_option( 'mini-cart-quantity', 1 ) ) {	
...
<?php else : ?>
	...
	<div class="woocommerce-mini-cart-empty">
		...
		<p class="woocommerce-mini-cart__empty-message"><?php echo apply_filters( 'kapee_woocommerce_empty_mini_cart_message', esc_html__( 'Shopping cart is empty!', 'kapee' ) ); ?></p>	
