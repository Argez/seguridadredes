...
class Codevz_Options {
	...
	public function init() {
		...
		self::$trasnlation = [
			...
			'Portfolio' => esc_html__( 'Portfolio', 'codevz' ),
		];
			...
			$tax_meta[] = [
				...
				'fields' 	=> [
				  array(
					...
					'content' 	=> Codevz_Plus::pro_badge(),
					'title'     => esc_html__( 'Brand logo', 'codevz' ),
					'button'    => esc_html__( 'Brand logo', 'codevz' ),
					'settings'  => []
				  ),
				]
			];
	...
	public static function css_out( $is_customize_preview = 0, $single_page = 0, $post_id = '' ) {
		...
		if ( ! empty( $opt['site_color'] ) ) {
			...
			$out .= "\n\n/* Theme color */" . 'a:hover, .sf-menu > .cz.current_menu > a, .sf-menu > .cz .cz.current_menu > a,.sf-menu > .current-menu-parent > a,.comment-text .star-rating span,.codevz-404 span {color: ' . $site_color . '} 
...
::-moz-selection {background-color: ' . $site_color . ';color: #fff}';
	...
	public static function customize_save_after( $manage, $old = '' ) {
		...
		if ( ! get_option( 'xtra_woo_create_wishlist' ) ) {
			...
			if ( ! post_exists( esc_html__( 'Wishlist', 'codevz' ) ) ) {

				$wishlist = wp_insert_post(
					[
						'post_title'    => esc_html__( 'Wishlist', 'codevz' ),
						'post_name' 	=> 'wishlist',
		...
		if ( ! get_option( 'xtra_woo_create_compare' ) ) {
			...
			if ( ! post_exists( esc_html__( 'Products Compare', 'codevz' ) ) ) {

				$compare = wp_insert_post(
					[
						'post_title'    => esc_html__( 'Products Compare', 'codevz' ),
	...
	public static function metabox() {
		...
		add_filter( 'codevz_metabox', function( $a ) use ( $free ) {
			...
			$a[0]['fields'][] = array(
				...
				'desc' 		=> esc_html__( 'To manage menus, visit Dashboard > Appearance > Menus', 'codevz' ),
				'options' 	=> array(
			...
			if ( self::get_post_type_admin() === 'post' && isset( $single_meta['source'] ) ) {
				...
				$a[0]['fields'][] = array(
					...
					'type' 		=> 'text',
					'title' 	=> esc_html__( 'Post source title', 'codevz' )
				);

				$a[0]['fields'][] = array(
					'id' 		=> 'post_source_link',
					'type' 		=> 'text',
					'title' 	=> esc_html__( 'Post source link', 'codevz' )
				);
		...
		$seo = Codevz_Plus::option( 'seo_meta_tags' ) ? array(
			...
			array(
				...
				array(
					'type'    => 'content',
					'content' => esc_html__( 'Unlock SEO options by going to Theme Options > General > SEO', 'codevz' )
				),
		);
		$seo = array(
		...
		return array(array(
				...
				array(
				  ...
				  'fields' => array(
					array(
						...
						'desc'  		=> esc_html__( 'The default sidebar position can be adjusted in Theme Options > General > Sidebar position', 'codevz' ),
						'options' 		=> [
							...
							'both-side' 	=> [ esc_html__( 'Both Sidebar', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 		, Codevz_Plus::$url . 'assets/img/sidebar-7.png' ],
							'both-side2' 	=> [ esc_html__( 'Both Sidebar Small', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/sidebar-8.png' ],
							'both-right' 	=> [ esc_html__( 'Both Sidebar Right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/sidebar-9.png' ],
							'both-right2' 	=> [ esc_html__( 'Both Sidebar Right 2', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) , Codevz_Plus::$url . 'assets/img/sidebar-10.png' ],
							'both-left' 	=> [ esc_html__( 'Both Sidebar Left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/sidebar-11.png' ],
							'both-left2' 	=> [ esc_html__( 'Both Sidebar Left 2', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' )  , Codevz_Plus::$url . 'assets/img/sidebar-12.png' ],
						],
			...
			array(
				...
				'type' 		=> $free ? 'content' : 'select',
				'content' 	=> Codevz_Plus::pro_badge(),
				'title' 	=> esc_html__( 'Custom header', 'codevz' ),
				'desc' 		=> esc_html__( 'This option lets you easily set a custom template.', 'codevz' ),
			...
			array(
				...
				'type' 		=> $free ? 'content' : 'select',
				'content' 	=> Codevz_Plus::pro_badge(),
				'title' 	=> esc_html__( 'Custom footer', 'codevz' ),
				'desc' 		=> esc_html__( 'This option lets you easily set a custom template.', 'codevz' ),
				'options' 	=> Codevz_Plus::$array_pages,
				'edit_link' => true
			),
	  ...
	  array(
		...
		'fields' => array(
			array(
				...
				'desc'      	=> esc_html__( 'The default option can be adjusted in Theme Options > Header > Title & Breadcrumbs', 'codevz' ),
				'options' 		=> [
		  ...
		  array(
			...
			'options' 		=> [
				...
				'rev'			=> [ esc_html__( 'Revolution Slider', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/title-slider.png' ],
				'image' 		=> [ esc_html__( 'Custom Image', 'codevz' ) 		, Codevz_Plus::$url . 'assets/img/title-image.png' ],
				'custom' 		=> [ esc_html__( 'Custom Shortcode', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/title-custom-code.png' ],
				'page' 			=> [ esc_html__( 'Custom Page Content', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 	, Codevz_Plus::$url . 'assets/img/title-custom-page.png' ],
			],
			'default' 		=> '1',
		  ...
		  array(
			...
			'desc'      => esc_html__( 'You can activate "Fixed Side" option from Theme Options > Header > Fixed Side', 'codevz' ),
		...
		if ( $i ) {
			return array(
				...
				array(
					...
					'type' 		=> 'textarea',
					'title' 	=> esc_html__( 'Custom Shortcode', 'codevz' ),
					'help' 		=> esc_html__( 'Shortcode and custom HTML code allowed.', 'codevz' ),
			...
			return array(
				array(
					...
					'type' 			=> 'codevz_image_select',
					'title' 		=> esc_html__( 'Header position', 'codevz' ),
					'help' 			=> esc_html__( 'The header position adjusts based on the page title and breadcrumbs', 'codevz' ),
					'options' 		=> [
				...
				array(
					...
					'help'  	=> esc_html__( 'This option applies to all internal pages of your website as default.', 'codevz' ),
					'default' 	=> ''
				),
				array(
					'id'    		=> 'page_cover_image',
				...
				array(
					...
					'options' 		=> array(
						...
						'10' 	=> esc_html__( 'Breadcrumbs + Title above content', 'codevz' ),
					),
				...
				array(
					...
					'type'      	=> $free ? 'content' : 'switcher',
					'content' 		=> Codevz_Plus::pro_badge(),
					'title'   		=> esc_html__( 'Post views count', 'codevz' ),
					'help'   		=> esc_html__( 'Showing post view count under the post title in single post', 'codevz' ),
				...
				array(
					...
					'help'   		=> esc_html__( 'Hide breadcrumbs if they are fewer than 3 levels', 'codevz' ),
				...
				array(
					...
					'content' 		=> Codevz_Plus::pro_badge(),
					'title' 		=> esc_html__( 'Home icon', 'codevz' ),
				...
				array(
					...
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'BR Container', 'codevz' ),
					'button' 		=> esc_html__( 'BR Container', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
					'settings' 		=> array( 'background', 'width', 'padding' ),
				...
				array(
					...
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'BR Inner Row', 'codevz' ),
					'button' 		=> esc_html__( 'BR Inner Row', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
					'settings' 		=> array( 'background', 'width', 'padding' ),
	...
	public static function options( $all = false ) {
		...
		$custom_stylekits[] = array(
			...
			'desc' 			=> $free ? '' : esc_html__( 'Saving and refreshing are necessary', 'codevz' ),
			'content' 		=> Codevz_Plus::pro_badge(),
		...
		$options[]   = array(
			...
			'sections' => array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> 'codevz_image_select',
							'title' 		=> esc_html__( 'Layout', 'codevz' ),
							'help' 			=> esc_html__( 'This option applies to overal website layout.', 'codevz' ),
							'options' 		=> [
						...
						array(
							'id'        => 'site_width',
							'type'      => 'slider',
							'help' 		=> esc_html__( 'The site width is flexible, supporting units like px, %, and em', 'codevz' ),
						...
						array(
							...
							'help' 			=> esc_html__( 'To maintain the desktop layout across all smaller devices', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge()
						),
						array(
							'id' 			=> 'sticky',
							...
							'help' 			=> esc_html__( "Sticky sidebar is a sidebar that remains fixed in place, ensuring it doesn't disappear when a user scrolls down the page", 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge()
						),
						array(
							'id'            => 'rtl',
							...
							'help' 			=> esc_html__( 'Change website direction from right to left by loading RTL styles.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge()
						),
					)
				),
				...
				array(
					...
					'fields' => wp_parse_args( $custom_stylekits, array(
						array(
							...
							'help'      => esc_html__( 'All primary website colors will replace.', 'codevz' ),
							'setting_args' => [ 'transport' => 'postMessage' ]
						),
						array(
							'id'        	=> 'site_color_sec',
							...
							'help'      	=> esc_html__( 'All secondary website colors will replace.', 'codevz' ) . ' ' . esc_html__( 'This color should be different from the accent color.', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ]
						),
						array(
							'id' 			=> 'dark',
							...
							'help' 			=> esc_html__( "Some sections feature dynamic colors, which may still appear in light mode. You'll need to locate and manually edit each setting", 'codevz' )
						),
						array(
							'type' 			=> 'notice',
							'class' 		=> 'info',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help' 		=> esc_html__( 'In which post type would you like to display social share icons?', 'codevz' ),
						...
						array(
							...
							'type' 		=> 'checkbox',
							'title' 	=> esc_html__( 'Share icons', 'codevz' ),
							'help' 		=> esc_html__( 'Which social share icons would you like to display?', 'codevz' ),
							'options' 	=> array(
								'facebook'	=> esc_html__( 'Facebook', 'codevz' ),
								'twitter'	=> esc_html__( 'X (Twitter)', 'codevz' ),
						...
						array(
							...
							'help' 		=> esc_html__( 'Original colors of social media icons', 'codevz' ),
							'options' 	=> array(
				...
				array(
					'name'   => 'general_seo',
					'title'  => esc_html__( 'SEO & Title tags', 'codevz' ),
					'fields' => array(
						array(
							'id' 			=> 'page_title_tag',
							'type' 			=> 'select',
							'title' 		=> esc_html__( 'Pages title tag', 'codevz' ),
							'help' 			=> esc_html__( 'Pages title tag in the Title and Breadcrumbs section, and above content.', 'codevz' ),
							'options' 		=> array(
								'' 				=> 'H1',
								'h2' 			=> 'H2',
								'h3' 			=> 'H3',
						...
						array(
							...
							'type' 			=> 'select',
							'title' 		=> esc_html__( 'Widgets title tag', 'codevz' ),
							'help' 			=> esc_html__( "Applies to any pages where you've set a sidebar containing widgets with titles.", 'codevz' ),
							'options' 		=> array(
								'h1' 			=> 'H1',
								'h2' 			=> 'H2',
								'h3' 			=> 'H3',
				...
				array(
					...
					'fields' => array(
						array(
							'id'            => 'first_load_fade',
							'type'          => $free ? 'content' : 'switcher',
							'title'         => esc_html__( 'First load fade', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						),
						array(
							...
							'type'			=> 'switcher',
							'title'			=> esc_html__( 'Loading', 'codevz' ),
							'help'			=> esc_html__( "After the page content loads, we'll smoothly animate the preloading screen out of view using a nice transition", 'codevz' ),
						),
						array(
							'id' 			=> 'loading_out_fx',
							'type' 			=> $free ? 'content' : 'select',
							'title' 		=> esc_html__( 'Effect', 'codevz' ),
							'help' 			=> esc_html__( 'Animate the preloading screen away from the viewport.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'options' 		=> array(
						...
						array(
							...
							'type'          => $free ? 'content' : 'select',
							'title'         => esc_html__( 'Type', 'codevz' ),
							'help' 			=> esc_html__( 'Choose between image, percentage and or custom HTML code.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'options'       => array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help'		=> esc_html__('Add your custom codes here such as google analytics.', 'codevz'),
				...
				array(
					...
					'fields'  => [
						[
							...
							'content' 		=> Codevz_Plus::pro_badge(),
							'title' 		=> esc_html__( 'Disable menus', 'codevz' ),
							'help' 			=> esc_html__( 'You can hide XTRA theme dashboard menus.', 'codevz' ),
							'options' 		=> [
								...
								'docs'			=> esc_html__( 'Hide Documentation', 'codevz' ),
								'youtube'		=> esc_html__( 'Hide Video Tutorials', 'codevz' ),
								'changelog'		=> esc_html__( 'Hide Change Log', 'codevz' ),
								'ticksy'		=> esc_html__( 'Hide Support', 'codevz' ),
								'faq'			=> esc_html__( 'Hide F.A.Q', 'codevz' ),
						...
						[
							...
							'type' 			=> $free ? 'content' : 'switcher',
							'content' 		=> Codevz_Plus::pro_badge(),
							'title' 		=> esc_html__( 'Exclude admin', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						],
						[
						...
						[
							'type' 			=> 'notice',
							'class' 		=> 'info',
							'content' 		=> esc_html__( 'Warning: If you change below options, your style.css for both parent and child theme will reset and override.', 'codevz' )
						],
						[
				...
				array(
					...
					'fields' => array(
						array(
							...
							'type'          => $free ? 'content' : 'select',
							'title'         => esc_html__( 'Cookie Notice', 'codevz' ),
							'help' 			=> esc_html__( 'A cookie notice is a banner that pops up as the first thing, when visitors arrive on your website and tell your visitor that the site is using cookies and then asks visitors to accept this.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'options'       => [
				...
				array(
					'name'   => 'magic_mouse',
					'title'  => esc_html__( 'Magic Mouse', 'codevz' ),
					'fields' => array(
						array(
							'id'            => 'magic_mouse',
							'type'          => $free ? 'content' : 'switcher',
						...
						array(
							...
							'type'          => $free ? 'content' : 'switcher',
							'title'         => esc_html__( 'Hide cursor', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
						...
						array(
							...
							'type'          => $free ? 'content' : 'switcher',
							'title'         => esc_html__( 'Invert color', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'dependency' 	=> [ 'magic_mouse', '==', 'true' ]
						),
						array(
							...
							'type'          => $free ? 'content' : 'checkbox',
							'title' 		=> esc_html__( 'Magnet on', 'codevz' ),
							'help' 			=> esc_html__( 'If you want enable magnet on any elements you can use custom class ".cz_magnet"', 'codevz' ),
							'options' 		=> [
								'a,button,input[type=\'button\']'	=> esc_html__( 'All links', 'codevz' ),
								'.logo a'						=> esc_html__( 'Logo', 'codevz' ),
								'.cz_social a'					=> esc_html__( 'Social icons', 'codevz' ),
								'.cz_btn'						=> esc_html__( 'Buttons', 'codevz' ),
								'.cz_header_button'				=> esc_html__( 'Header buttons', 'codevz' ),
								'.sf-menu a,.codevz-widget-custom-menu-horizontal a'		=> esc_html__( 'Menu items', 'codevz' ),
								'.cz_elm > i'					=> esc_html__( 'Menu icon', 'codevz' ),
								'.xtra-search-icon' 			=> esc_html__( 'Search icon', 'codevz' ),
								'.shop_icon > i'				=> esc_html__( 'Shop cart icon', 'codevz' ),
								'.wishlist_icon > i'			=> esc_html__( 'Wishlist icon', 'codevz' ),
								'.compare_icon > i'				=> esc_html__( 'Compare icon', 'codevz' ),
								'.backtotop'					=> esc_html__( 'Backtotop icon', 'codevz' ),
								'i.fixed_contact'				=> esc_html__( 'Quick contact', 'codevz' ),
								'.slick-arrow i'				=> esc_html__( 'Carousel arrows', 'codevz' ),
								'.cz_magnet'					=> esc_html__( 'Custom class', 'codevz' ),
							],
							'dependency' 	=> [ 'magic_mouse', '==', 'true' ],
						...
						array(
							...
							'title' 		=> esc_html__( 'Inner circle', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						...
						array(
							...
							'type' 			=> $free ? 'content' : 'color_picker',
							'title' 		=> esc_html__( 'Outer circle', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> [ 'background', 'width', 'height', 'border' ],
							'dependency' 	=> [ 'magic_mouse', '==', 'true' ]
						...
						array(
							...
							'type' 			=> $free ? 'content' : 'color_picker',
							'title' 		=> esc_html__( 'On hover', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> [ 'background', 'width', 'height', 'border' ],
							'dependency' 	=> [ 'magic_mouse', '==', 'true' ]
						...
						array(
							...
							'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
							'title' 		=> esc_html__( 'Inner circle', 'codevz' ),
							'button' 		=> esc_html__( 'Inner circle', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						...
						array(
							...
							'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
							'title' 		=> esc_html__( 'Outer circle', 'codevz' ),
							'button' 		=> esc_html__( 'Outer circle', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'width', 'height', 'border' ),
						...
						array(
							...
							'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
							'title' 		=> esc_html__( 'On Hover', 'codevz' ),
							'button' 		=> esc_html__( 'On Hover', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'width', 'height', 'border' ),
				...
				array(
					'name'   => 'general_pwa',
					'title'  => esc_html__( 'Progressive Web App', 'codevz' ),
					'fields' => array(

						array(
							'type'    		=> 'notice',
							'class'   		=> 'info',
							'content' 		=> esc_html__( "Enable this option to convert your website into the web application. A progressive web app (PWA) is an app that's built using web platform technologies, but that provides a user experience like that of a platform-specific app", 'codevz' )
						),
						array(
							'id' 			=> 'pwa',
							'type' 			=> $free ? 'content' : 'switcher',
						...
						array(
							'id' 			=> 'pwa_icon',
							'type' 			=> $free ? 'content' : 'upload',
							'title' 		=> esc_html__( 'App icon', 'codevz' ),
							'help' 			=> esc_html__( 'The application icon should be in PNG format, 512x512 pixels, and high quality', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						...
						array(
							'id' 			=> 'pwa_name',
							'type' 			=> $free ? 'content' : 'text',
							'title' 		=> esc_html__( 'App name', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							'id' 			=> 'pwa_short_name',
							'type' 			=> $free ? 'content' : 'text',
							'title' 		=> esc_html__( 'App short name', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							'id' 			=> 'pwa_desc',
							'type' 			=> $free ? 'content' : 'textarea',
							'title' 		=> esc_html__( 'App description', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							'id' 			=> 'pwa_theme_color',
							'type' 			=> $free ? 'content' : 'color_picker',
							'title' 		=> esc_html__( 'App theme color', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							...
							'type' 			=> $free ? 'content' : 'color_picker',
							'title' 		=> esc_html__( 'App background color', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							'id' 			=> 'pwa_cookie_name',
							'type' 			=> $free ? 'content' : 'text',
							'title' 		=> esc_html__( 'Custom cookie', 'codevz' ),
							'help' 			=> esc_html__( 'Useful if you want to reset and display the PWA popup again to old users', 'codevz' ),
							'attributes' 	=> [
						...
						array(
							'type'    		=> 'notice',
							'class'   		=> 'info',
							'content' 		=> esc_html__( 'Popup styling', 'codevz' ),
							'dependency' 	=> [ 'pwa', '==', 'true' ]
						),
						array(
							'id' 			=> '_css_pwa_overlay',
						...
						array(
							'id' 			=> '_css_pwa_close',
							'type'  		=> $free ? 'cz_sk_free' : 'cz_sk',
							'title' 		=> esc_html__( 'Close icon', 'codevz' ),
					...
					'fields' => array(
						...
						array(
							...
							'options' 		=> [
								...
								'true' 			=> esc_html__( 'jQuery Custom Lazyload', 'codevz' ),
							],
						...
						array(
							...
							'help'          => esc_html__( 'Any image format is allowed', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args'  => [ 'transport' => 'postMessage' ],
						...
						array(
							...
							'content' 		=> Codevz_Plus::pro_badge(),
							'help'          => esc_html__( 'You can create a coming soon or maintenance mode page and assign it here, This will redirect all your website visitors to that designated page', 'codevz' ),
						...
						array(
							...
							'attributes' 	=> [
								'placeholder' 	=> esc_html__( 'We are currently in maintenance mode. We will be back soon', 'codevz' )
							],
						...
						array(
							...
							'help'          => esc_html__( 'Disable comments and comment form on all blog posts.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						),
						array(
						...
						array(
							...
							'type'          => $free ? 'content' : 'switcher',
							'title'         => esc_html__( 'Disable RTL numbers', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						),
						array(
				...
				array(
					...
					'fields' => array(
						array(
							...
							'help' 		=> esc_html__( 'Create a template or page and assign it as custom template here.', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages,
							'edit_link' => true
						),
						array(
							...
							'type'  	=> $free ? 'content' : 'select',
							'content' 	=> Codevz_Plus::pro_badge(),
							'title' 	=> esc_html__( 'Tablet & mobile', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages,
							'edit_link' => true
						),
						array(
						...
						array(
							...
							'type'  	=> $free ? 'content' : 'select',
							'content' 	=> Codevz_Plus::pro_badge(),
							'title' 	=> esc_html__( 'Custom sticky', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages,
							'edit_link' => true,
							'dependency' => [ 'header_elementor_sticky', '==', 'true' ],
						),
				...
				array(
					...
					'fields' => [
						...
						array(
							...
							'help' 		=> esc_html__( 'Fixed navigation bars allow visitors to quickly access the main site links, remaining constantly visible at the bottom of the website', 'codevz' ),
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help' 			=> esc_html__( 'Expand/collapse panel designed to optimize the display of content in limited spaces by means of an “expand/collapse” system.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'options'       => Codevz_Plus::$array_pages,
							'edit_link' 	=> true
						),
				...
				array(
					...
					'fields' => array(
						array(
							...
							'help' 	=> esc_html__( 'Manage footer widgets from Theme Options > Widgets', 'codevz' ),
							'options' => array(
				...
				array(
					...
					'fields' => array(
						array(
							...
							'help'			=> esc_html__( "To ensure the fixed footer's visibility, set the body background color. Navigate to General > Colors > Body", 'codevz' ),
						),
						array(
							'id'    		=> 'backtotop',
							'type'  		=> 'icon',
							'title' 		=> esc_html__( 'Back to top', 'codevz' ),
							'help' 			=> esc_html__( 'The sticky back to top button is a helpful navigation element that helps users get back to the top of the web page they’re viewing.', 'codevz' ),
						...
						array(
							...
							'type' 			=> $free ? 'content' : 'select',
							'content' 		=> Codevz_Plus::pro_badge(),
							'title' 		=> esc_html__( 'Quick contact box', 'codevz' ),
							'help' 			=> esc_html__( 'Select the page that contains contact form element.', 'codevz' ),
							'options'       => wp_parse_args( Codevz_Plus::$array_pages, [
								'' 				=> esc_html__( '~ Disable ~', 'codevz' ),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> 'codevz_image_select',
							'title' 		=> esc_html__( 'Sidebar', 'codevz' ),
							'help'  		=> esc_html__( 'Sidebar position for archive and single posts', 'codevz' ),
							'options' 		=> [
								'1' 			=> [ esc_html__( '~ Default ~', 'codevz' ) 		, Codevz_Plus::$url . 'assets/img/sidebar-0.png' ],
						...
						array(
							...
							'help'  		=> esc_html__( 'Archive, tag and category pages.', 'codevz' ),
							'options' 		=> [
								...
								'x' 			=> [ esc_html__( 'Custom Template', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ) 		, Codevz_Plus::$url . 'assets/img/posts-x.png' ],
							],
							'default' 		=> '1',
						...
						array(
							'id'    	=> 'posts_per_page',
							'type'  	=> 'slider',
							'title' 	=> esc_html__( 'Posts length', 'codevz' ),
						...
						array(
							...
							'help' 			=> esc_html__( 'Enlarge the post thumbnails to a size larger than their current dimensions', 'codevz' ),
						...
						array(
							...
							'help' 			=> esc_html__('Displaying an SVG cover for posts lacking a featured image', 'codevz'),
							'dependency' 	=> array( 'template_style', '!=', 'x' ),
						),
						array(
							'id'    		=> 'post_excerpt',
						...
						array(
							...
							'help' 			=> esc_html__( 'Excerpt by post words or characters.', 'codevz' ),
							'options' 		=> [
					...
					'fields' => array(
						...
						array(
							...
							'options' 	=> array(
								...
								'source'	=> esc_html__( 'Source', 'codevz' ),
								...
								'views' 	=> esc_html__( 'Post views', 'codevz' ),
							),
						...
						array(
							...
							'type'  		=> $free ? 'content' : 'select',
							'content' 		=> Codevz_Plus::pro_badge(),
							'title' 		=> esc_html__( 'Post meta display', 'codevz' ),
							'options' 		=> [
								'' 						=> esc_html__( 'Inline', 'codevz' ),
								'cz_post_meta_block' 	=> esc_html__( 'Block', 'codevz' ),
							]
						),
						array(
							...
							'type'  	=> $free ? 'content' : 'switcher',
							'content' 	=> Codevz_Plus::pro_badge(),
							'title' 	=> esc_html__( 'Post meta title', 'codevz' )
						),
						array(
							'id' 			=> 'related_post_col',
							'type' 			=> 'codevz_image_select',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Title meta', 'codevz' ),
							'button' 		=> esc_html__( 'Title meta', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
			  ...
			  array(
				...
				'fields' => array(
					array(
						...
						'type' 			=> 'codevz_image_select',
						'title' 		=> esc_html__( 'Sidebar', 'codevz' ),
						'help'  		=> esc_html__( 'The default sidebar setting can be adjusted in General > Layout', 'codevz' ),
						'options' 		=> [
							'1' 			=> [ esc_html__( '~ Default ~', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-0.png' ],
							'ws' 			=> [ esc_html__( 'No Sidebar', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/off.png' ],
							'bpnp' 			=> [ esc_html__( 'Fullwidth', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-2.png' ],
		...
		foreach( self::post_types() as $cpt ) {
			...
			$options[] = array(
				...
				'sections' 	=> array(
					...
					array(
						'name'   => $cpt . '_settings',
						'title'  => $cpt_title . ' ' . esc_html__( 'Settings', 'codevz' ),
						'fields' => wp_parse_args( 
							array(
								...
								array(
									...
									'type' 		=> $free ? 'content' : 'textarea',
									'content' 	=> Codevz_Plus::pro_badge(),
									'title' 	=> esc_html__( 'Archive Description', 'codevz' ),
									'help'  	=> esc_html__( 'Shortcode and custom HTML code allowed.', 'codevz' )
								),
								array(
					...
					array(
						'name'   => $cpt . '_styles',
						'title'  => $cpt_title . ' ' . esc_html__( 'Styling', 'codevz' ),
						'fields' => array(
							array(
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'help' 			=> esc_html__( 'Enable this option you will be able to override single posts styling for this post type.', 'codevz' ),
							),
							array(
				...
				'fields' => wp_parse_args( 
					array(
						array(
							...
							'type' 			=> 'codevz_image_select',
							'title' 		=> esc_html__( 'Sidebar', 'codevz' ),
							'help'  		=> esc_html__( 'On all bbpress pages', 'codevz' ),
							'options' 		=> [
								'1' 			=> [ esc_html__( '~ Default ~', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-0.png' ],
								'ws' 			=> [ esc_html__( 'No Sidebar', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/off.png' ],
								'bpnp' 			=> [ esc_html__( 'Fullwidth', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-2.png' ],
			...
			$options[] = array(
				...
				'sections'  => array(
						...
						'fields' => wp_parse_args(
							array(
								array(
									...
									'type' 			=> 'codevz_image_select',
									'title' 		=> esc_html__( 'Sidebar', 'codevz' ),
									'help'  		=> esc_html__( 'On all product pages', 'codevz' ),
									'options' 		=> [
										'1' 			=> [ esc_html__( '~ Default ~', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-0.png' ],
										'ws' 			=> [ esc_html__( 'No Sidebar', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/off.png' ],
										'bpnp' 			=> [ esc_html__( 'Fullwidth', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-2.png' ],
								...
								array(
									...
									'type'  		=> 'slider',
									'title' 		=> esc_html__( 'Products count', 'codevz' ),
									'options'		=> array( 'unit' => '', 'step' => 1, 'min' => -1, 'max' => 100 ),
								),
								array(
									'id'    		=> 'woo_ppp_dropdown',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Count dropdown', 'codevz' ),
									'help' 			=> esc_html__( 'Showing products count dropdown above products in archive pages.', 'codevz' )
								),
								array(
									'id' 			=> 'woo_order',
									'type' 			=> $free ? 'content' : 'select',
								...
								array(
									...
									'help' 			=> esc_html__( 'Image hover effects are effects that are applied to an image, activated when someone hovers the mouse over product.', 'codevz' ),
									'options' 		=> [
										'' 				=> esc_html__( '~ Disable ~', 'codevz' ),
								...
								array(
									...
									'help' 			=> esc_html__( 'Display the sale percentage as "-50%" instead of a sale badge', 'codevz' ),
									'content' 		=> Codevz_Plus::pro_badge(),
									'options'       => array(
										''							=> esc_html__( '~ Default ~', 'codevz' ),
										'woo-sale-percentage'		=> esc_html__( 'Percentage', 'codevz' ),
										'woo-sale-text-percentage'	=> esc_html__( 'Text + Percentage', 'codevz' ),
									)
								),
								array(
									...
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Cart notification?', 'codevz' ),
									'help' 			=> esc_html__( 'Displaying a notification message when a product has been successfully added to the cart', 'codevz' )
								),
								array(
									'id'    		=> 'woo_new_label',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'New badge?', 'codevz' ),
									'help' 			=> esc_html__( 'Adding a new badge to the product image, similar to a sale badge', 'codevz' )
								),
								array(
									'id'    		=> 'woo_new_label_days',
									'type'  		=> $free ? 'content' : 'slider',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'New badge days', 'codevz' ),
									'options'		=> array( 'unit' => '', 'step' => 1, 'min' => 1, 'max' => 365 ),
									'help' 			=> esc_html__( "How many days should the 'NEW' badge remain visible?", 'codevz' ),
									'default' 		=> '1',
								...
								array(
									...
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Short products title?', 'codevz' ),
									'help' 			=> esc_html__( 'Shortening product titles to maintain consistent product heights.', 'codevz' )
								),
								array(
									'id'    		=> 'woo_category_under_title',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Products category?', 'codevz' ),
									'help' 			=> esc_html__( 'Display the first category name of the product under the title in the shop archive', 'codevz' )
								),
								array(
									...
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Short description?', 'codevz' ),
									'help' 			=> esc_html__( 'Displaying the short description of products under the title and category', 'codevz' )
								),
								array(
									'id'    		=> 'woo_wishlist',
									'type'  		=> $free ? 'content' : 'switcher',
									...
									'help' 			=> esc_html__( 'WooCommerce Wishlists allows guests and customers to create and add products to an unlimited number of Wishlists.', 'codevz' )
								),
								array(
									'id'    		=> 'woo_compare',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Compare', 'codevz' ),
									'help' 			=> esc_html__( 'WooCommerce compare allows guests and customers to compare products between each others.', 'codevz' )
								),
								array(
									'id'    		=> 'woo_quick_view',
									'type'  		=> $free ? 'content' : 'switcher',
									...
									'help' 			=> esc_html__( 'The quick view is a button to show product details in a lightbox when clicked.', 'codevz' )
								),
								array(
									...
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Center Mode', 'codevz' ),
									'help' 			=> esc_html__( 'Move wishlist, compare and quick view icons to the center of products.', 'codevz' )
								),
								array(
									'id'    		=> 'woo_sold_out_badge',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Sold out badge', 'codevz' )
								),
								array(
									'id'    		=> 'woo_sold_out_grayscale',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Sold out grayscale', 'codevz' )
								),
								array(
									'id'    		=> 'woo_show_zero_count',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Header cart zero number', 'codevz' ),
								),
								array(
									'id'    		=> 'woo_cart_page_related_products',
									'type'  		=> $free ? 'content' : 'switcher',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Cart page related products', 'codevz' ),
									'help' 			=> esc_html__( 'Show related products on the cart page based on items in the cart and random products when the cart is empty.', 'codevz' )
								),
								array(
									'id' 			=> 'woo_cart_checkout_steps',
									'type' 			=> $free ? 'content' : 'select',
									'content' 		=> Codevz_Plus::pro_badge(),
									'title' 		=> esc_html__( 'Checkout steps', 'codevz' ),
									'help' 			=> esc_html__( 'Show 3 steps above on cart, checkout and order completion pages.', 'codevz' ),
									'options' 		=> array(
										''				=> esc_html__( '~ Disable ~', 'codevz' ),
								...
								array(
									...
									'type'  		=> 'text',
									'title' 		=> esc_html__( 'Sold out', 'codevz' ),
									'default' 		=> esc_html__( 'Sold out', 'codevz' ),
									'setting_args' 	=> [ 'transport' => 'postMessage' ],
								),
								array(
									'id'    		=> 'woo_cart',
								...
								array(
									'id'    		=> 'woo_cart_footer',
									'type'  		=> 'text',
									'title' 		=> esc_html__( 'Mini cart footer', 'codevz' ),
									'setting_args' 	=> [ 'transport' => 'postMessage' ],
								),
								array(
									'id'    		=> 'woo_continue_shopping',
									'type'  		=> 'text',
									'title' 		=> esc_html__( 'Continue shop', 'codevz' ),
								...
								array(
									'id'    		=> 'woo_no_products',
									'type'  		=> 'text',
									'title' 		=> esc_html__( 'Cart no prodcuts', 'codevz' ),
									'default' 		=> esc_html__( "Cart's empty! Let's fill it up!", 'codevz' ),
									'setting_args' 	=> [ 'transport' => 'postMessage' ],
								),
							),
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Category', 'codevz' ),
								'button' 		=> esc_html__( 'Category', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'New Badge', 'codevz' ),
								'button' 		=> esc_html__( 'New Badge', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'background' ),
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Short description', 'codevz' ),
								'button' 		=> esc_html__( 'Short description', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Compare', 'codevz' ),
								'button' 		=> esc_html__( 'Compare', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border', 'box-shadow' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Cart notification', 'codevz' ),
								'button' 		=> esc_html__( 'Cart notification', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Mini cart footer', 'codevz' ),
								'button' 		=> esc_html__( 'Mini cart footer', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
					...
					array(
						...
						'fields' => array(
							array(
								...
								'type' 			=> 'codevz_image_select',
								'title' 		=> esc_html__( 'Sidebar', 'codevz' ),
								'help'  		=> esc_html__( 'On all single product pages', 'codevz' ),
								'options' 		=> [
									'1' 			=> [ esc_html__( '~ Default ~', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-0.png' ],
									'ws' 			=> [ esc_html__( 'No Sidebar', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/off.png' ],
									'bpnp' 			=> [ esc_html__( 'Fullwidth', 'codevz' ) 			, Codevz_Plus::$url . 'assets/img/sidebar-2.png' ],
							...
							array(
								...
								'help' 		=> esc_html__( 'You can disable default built-in woocommerce features for single product.', 'codevz' ),
								'options' 	=> array(
									'zoom'		=> esc_html__( 'Disable', 'codevz' ) . ' ' . esc_html__( 'Hover zoom', 'codevz' ),
									'lightbox'	=> esc_html__( 'Disable', 'codevz' ) . ' ' . esc_html__( 'Lightbox', 'codevz' ),
									'slider'	=> esc_html__( 'Disable', 'codevz' ) . ' ' . esc_html__( 'Slider', 'codevz' ),
								),
							),
							array(
								...
								'type'  		=> $free ? 'content' : 'textarea',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Content after product meta', 'codevz' ),
								'help' 			=> esc_html__( 'You can add text, content, HTML, or a shortcode, which will be displayed after the product meta on all product pages.', 'codevz' )
							),
							array(
								'id'    		=> 'woo_product_sticky_add_to_cart',
								'type'  		=> $free ? 'content' : 'switcher',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Sticky add to cart?', 'codevz' ),
								'help' 			=> esc_html__( 'Showing fixed add to cart section on scroll in the product single page.', 'codevz' )
							),
							array(
								'id' 		=> 'woo_product_tabs',
								'type' 		=> $free ? 'content' : 'select',
								...
								'help' 		=> esc_html__( 'Choose tabs type between default, center and vertical mode.', 'codevz' ),
								'options' 	=> array(
									''			=> esc_html__( '~ Default ~', 'codevz' ),
									'center'	=> esc_html__( 'Center', 'codevz' ),
									'vertical'	=> esc_html__( 'Vertical', 'codevz' ),
							...
							array(
								...
								'type'  		=> $free ? 'content' : 'switcher',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Sticky tabs?', 'codevz' ),
								'help' 			=> esc_html__( 'Make the product tabs row sticky at the top of the screen on page scrolls', 'codevz' ),
							...
							array(
								...
								'type'  		=> $free ? 'content' : 'switcher',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Brand tab?', 'codevz' ),
								'help' 			=> esc_html__( 'Showing brand info tab in the product page if product have a brand.', 'codevz' )
							),
							array(
								...
								'help' 			=> esc_html__( 'Showing default size guide tab in the product page for all products, also you can add separate size guide for each product from Dashboard > Products > Size Guide.', 'codevz' )
							),
							array(
								'id'    		=> 'woo_product_size_guide_tab_title',
								'type'  		=> $free ? 'content' : 'text',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Tab title', 'codevz' ),
								'help' 			=> esc_html__( 'If you want only show on some products, then leave this empty and from your dashboard add size guide and select it in edit product page.', 'codevz' ),
							...
							array(
								...
								'help' 			=> esc_html__( 'Showing default FAQ tab in the product page for all products, also you can add separate FAQ for each product from Dashboard > Products > FAQ.', 'codevz' )
							),
							array(
								...
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Tab title', 'codevz' ),
								'help' 			=> esc_html__( 'If you want only show on some products, then leave this empty and from your dashboard add FAQ and select it in edit product page.', 'codevz' ),
							...
							array(
								...
								'type'  		=> $free ? 'content' : 'switcher',
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Shipping & Returns?', 'codevz' ),
								'help' 			=> esc_html__( 'Showing shipping and return tab in the product page.', 'codevz' )
							),
							array(
							...
							array(
								'id' 			=> 'woo_related_col',
								'type' 			=> 'codevz_image_select',
								'title' 		=> esc_html__( 'Related products columns', 'codevz' ),
								'options' 		=> [
							...
							array(
								...
								'content' 		=> Codevz_Plus::pro_badge(),
								'title' 		=> esc_html__( 'Recently viewed products', 'codevz' ),
								'options' 		=> [
									'0' 			=> [ esc_html__( 'Off', 'codevz' ) 					, Codevz_Plus::$url . 'assets/img/off.png' ],
									'2' 			=> [ '2 ' . esc_html__( 'Columns', 'codevz' ) 		, Codevz_Plus::$url . 'assets/img/cols-2.png' ],
									'3' 			=> [ '3 ' . esc_html__( 'Columns', 'codevz' ) 		, Codevz_Plus::$url . 'assets/img/cols-3.png' ],
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Inner column', 'codevz' ),
								'button' 		=> esc_html__( 'Inner column', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'background', 'padding', 'border' ),
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Variation option', 'codevz' ),
								'button' 		=> esc_html__( 'Variation option', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Sticky add to cart', 'codevz' ),
								'button' 		=> esc_html__( 'Sticky add to cart', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'background', 'border' ),
					...
					array(
						...
						'title'  => esc_html__( 'Others Styling', 'codevz' ),
						'fields' => array(

							array(
								'id' 			=> '_css_woo_others_message_box',
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Message Wrapper', 'codevz' ),
								'button' 		=> esc_html__( 'Message Wrapper', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Message SVG icon', 'codevz' ),
								'button' 		=> esc_html__( 'Message SVG icon', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'border', 'border-radius' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Checkout Coupon', 'codevz' ),
								'button' 		=> esc_html__( 'Checkout Coupon', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Cart Remove', 'codevz' ),
								'button' 		=> esc_html__( 'Cart Remove', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Cart Thumbnail', 'codevz' ),
								'button' 		=> esc_html__( 'Cart Thumbnail', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Account Nav', 'codevz' ),
								'button' 		=> esc_html__( 'Account Nav', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Account Links', 'codevz' ),
								'button' 		=> esc_html__( 'Account Links', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'Account Icons', 'codevz' ),
								'button' 		=> esc_html__( 'Account Icons', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
	...
	public static function elements( $id, $title, $dependency = array(), $pos = '' ) {
		...
		return array(
			...
			'type'            => 'group',
			'title'           => $title,
			'button_title'    => esc_html__( 'Add', 'codevz' ) . ' ' . ucwords( isset( self::$trasnlation[ $pos ] ) ? self::$trasnlation[ $pos ] : '' ),
			'accordion_title' => esc_html__( 'Add', 'codevz' ) . ' ' . ucwords( isset( self::$trasnlation[ $pos ] ) ? self::$trasnlation[ $pos ] : '' ),
			...
			'fields'          => array(
				...
				array(
					...
					'options' => array(
						...
						'logo_2' 	=> esc_html__( 'Logo alternative', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						...
						'wishlist'  => esc_html__( 'WooCommerce wishlist', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'compare' 	=> esc_html__( 'WooCommerce compare', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'wpml' 		=> esc_html__( 'WPML Selector', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'widgets' 	=> esc_html__( 'Offcanvas sidebar', 'codevz' ),
						'hf_elm' 	=> esc_html__( 'Dropdown content', 'codevz' ),
						//'login' 	=> esc_html__( 'Login Box', 'codevz' ),
						'avatar' 	=> esc_html__( 'Logged-in user avatar', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom' 	=> esc_html__( 'Custom shortcode', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom_element' => esc_html__( 'Custom page', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					),
					'default_option' => esc_html__( '~ Select ~', 'codevz'),
				),
				...
				[
					'id'   		 => 'pro_message',
					'type'       => 'content',
					'content'    => esc_html__( 'Available only on PRO version.', 'codevz' ),
				...
				array(
					...
					'type' 			=> $free ? 'content' : 'text',
					'content' 		=> Codevz_Plus::pro_badge(),
					'title' 		=> esc_html__( 'Logo slogan', 'codevz' ),
					'dependency' => array( 'element', 'any', $free ? 'logo' : 'logo,logo_2' ),
				),
				array(
					'id' 			=> 'sk_logo_slogan',
					'type' 			=> $free ? 'content' : 'cz_sk',
					'content' 		=> Codevz_Plus::pro_badge(),
					'title' 		=> esc_html__( 'Slogan style', 'codevz' ),
					'button' 		=> esc_html__( 'Slogan style', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
				...
				array(
					...
					'type' 		=> 'select',
					'title' 	=> esc_html__( 'Menu', 'codevz' ),
					'help' 		=> esc_html__( 'To create or modify menus, visit Dashboard > Appearance > Menus', 'codevz' ),
					'options' 	=> array(
						'' 			=> esc_html__( '~ Select ~', 'codevz' ), 
						'primary' 	=> esc_html__( 'Primary', 'codevz' ), 
						'secondary' => esc_html__( 'Secondary', 'codevz' ), 
						...
						'footer'  	=> esc_html__( 'Footer', 'codevz' ),
						'mobile'  	=> esc_html__( 'Mobile', 'codevz' ),
						'custom-1' 	=> esc_html__( 'Custom 1', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ), 
						'custom-2' 	=> esc_html__( 'Custom 2', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ), 
						'custom-3' 	=> esc_html__( 'Custom 3', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom-4' 	=> esc_html__( 'Custom 4', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom-5' 	=> esc_html__( 'Custom 5', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom-6' 	=> esc_html__( 'Custom 6', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom-7' 	=> esc_html__( 'Custom 7', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'custom-8' 	=> esc_html__( 'Custom 8', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' )
					),
					'edit_link'  => get_admin_url( false, 'nav-menus.php' ),
				...
				array(
					...
					'options' 	=> array(
						...
						'open_horizontal inview_left'  => esc_html__( 'Sliding menu left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'open_horizontal inview_right' => esc_html__( 'Sliding menu right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'left_side_dots side_dots' 	   => esc_html__( 'Vertical dots left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'right_side_dots side_dots'    => esc_html__( 'Vertical dots right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					),
					'dependency' => array( 'element', '==', 'menu' ),
				),
				array(
				...
				array(
					'type'    		=> 'content',
					'content' 		=> '<a href="#" onclick="wp.customize.section( \'codevz_theme_options-header_social\' ).focus()" class="button xtra-goto">' . esc_html__( 'Go to social icons manager', 'codevz' ) . '</a>',
				...
				array(
					...
					'options' 	=> array(
						'' 				=> esc_html__( '~ Default ~', 'codevz' ),
						'popup' 		=> esc_html__( 'Popup', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
						'dropdown' 		=> esc_html__( 'Dropdown', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					),
					'dependency' => array( 'element', '==', 'social' ),
				),
				array(
				...
				array(
					'id' 			=> 'sk_image',
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'Image style', 'codevz' ),
					'button' 		=> esc_html__( 'Image style', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
				...
				array(
					...
					'help'  		=> esc_html__( 'Instead of the current year, you can use [codevz_year]', 'codevz' ),
					'dependency' 	=> array( 'element', 'any', 'icon,icon_info' ),
				),
				array(
					'id'    		=> 'it_text_2',
				...
				array(
					...
					'type' 		=> $free ? 'content' : 'switcher',
					'content' 	=> Codevz_Plus::pro_badge(),
					'title'		=> esc_html__( 'Category selection?', 'codevz' ),
				...
				array(
					...
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'Category selection', 'codevz' ),
					'button' 		=> esc_html__( 'Category selection', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
					'settings' 		=> array( 'font-size', 'color', 'background', 'border' ),
				...
				array(
					...
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'Categories list', 'codevz' ),
					'button' 		=> esc_html__( 'Categories list', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
					'settings' 		=> array( 'font-size', 'color', 'background', 'border' ),
					'dependency' 	=> array( 'element|search_products_categories', '==|==', 'search|true' ),
				),
				array(
					...
					'help'		=> esc_html__( 'Navigate to Blog > Search Settings to configure the search query', 'codevz' ),
					'dependency' => array( 'element', '==', 'search' ),
				),
				array(
					'id' 		=> 'search_count',
				...
				array(
					'type'    		=> 'content',
					'content' 		=> '<a href="#" onclick="wp.customize.section( \'codevz_theme_options-products\' ).focus()" class="button xtra-goto">' . esc_html__( 'Go to products settings', 'codevz' ) . '</a>',
					'dependency' 	=> array( 'element', '==', 'shop_cart' ),
				),
				array(
					'id'    		=> 'shopcart_icon',
	...
	public static function row_options( $id, $positions = array('left', 'center', 'right') ) {
		...
		if ( $id === 'header_5' ) {
			...
			$out[] = array(
				...
				'type' 		=> 'select',
				'title' 	=> esc_html__( 'Type', 'codevz' ),
				'help' 		=> esc_html__( 'Keeping the header of your website in the same place on the screen while the user scrolls down the page.', 'codevz' ),
				'options' 	=> array(
					''			=> esc_html__( '~ Disable ~', 'codevz' ),
					...
					'12'    	=> esc_html__( 'Header top bar + Header', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'23'    	=> esc_html__( 'Header + Header bottom bar', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'13'    	=> esc_html__( 'Header top bar + Header bottom bar', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					$free ? 'x' : '5'			=> esc_html__( 'Create custom sticky', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				)
			);
			$out[] = array(
				'id' 		=> 'smart_sticky',
				...
				'content' 	=> Codevz_Plus::pro_badge(),
				'title' 	=> esc_html__( 'Smart Sticky', 'codevz' ),
				'help' 		=> esc_html__( 'It will Hide the header when user scroll down but show the header when user scroll up.', 'codevz' ),
		...
		if ( $id === 'fixed_side_1' ) {
			$out[] = array(
				...
				'type' 			=> 'codevz_image_select',
				'title' 		=> esc_html__( 'Fixed Side', 'codevz' ),
				'help' 			=> esc_html__( 'Visible area and it’s elements all the time and while scrolling the page.', 'codevz' ),
				'options' 		=> [
		...
		if ( $id === 'header_4' ) {
			...
			$out[] = array(
			  ...
			  'help' 		  => esc_html__( 'Assign the custom template section before the mobile header.', 'codevz' ),
			  'options'       => Codevz_Plus::$array_pages,
			  'edit_link' 	  => true
			);
			...
			$out[] = array(
			  ...
			  'help' 		  => esc_html__( 'Assign the custom template section after the mobile header.', 'codevz' ),
			  'options'       => Codevz_Plus::$array_pages,
				'edit_link'   => true
			);
	...
	public static function revSlider( $out = array() ) {
		...
		if ( class_exists( 'RevSlider' ) ) {
			...
			if ( empty( $out ) ) {
				$out = array( esc_html__( 'Could not be found. Please create a new one from the Revolution Slider menu', 'codevz' ) );
			}

		} else {

			$out = array( esc_html__( "Sorry, the Revolution Slider hasn't been installed or activated", 'codevz' ) );
