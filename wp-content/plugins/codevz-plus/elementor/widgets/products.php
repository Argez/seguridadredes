...
class Xtra_Elementor_Widget_products extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'popularity' 	=> esc_html__( 'Popularity', 'codevz' ),
					'rand' 			=> esc_html__( 'Rand', 'codevz' ),
					'rating' 		=> esc_html__( 'Rating', 'codevz' ),
	...
	protected function render() {
		...
		echo do_shortcode( '[' . esc_attr( $settings['type'] ) . ' columns="' . esc_attr( $settings['columns'] ) . '" limit="' . esc_attr( $settings['limit'] ) . '" paginate="' . esc_attr( $paginate ) . '" orderby="' . esc_attr( $settings['orderby'] ) . '" order="' . esc_attr( $settings['order'] ) . '" on_sale="' . esc_attr( $settings['on_sale'] ) . '"]' );
