...
class Xtra_Elementor_Widget_title extends Widget_Base {
	...
	public function register_controls() {
		...
		$this->start_controls_section(
			'section_fancy_fx',
			[
				'label' => esc_html__( 'Fancy animation', 'codevz' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => esc_html__( 'Select', 'codevz' ),
					'codevz-fancy-words' => esc_html__( 'Fancy words', 'codevz' ),
					'codevz-fancy-letters' => esc_html__( 'Fancy letters', 'codevz' ),
					'codevz-fancy-line' => esc_html__( 'Fancy line', 'codevz' ),
				],
			]
		);
		...
		$this->add_control(
			'fancy_speed',
			[
				'label' => esc_html__( 'Fancy speed', 'codevz' ),
		...
		$this->add_control(
			'fancy_delay',
			[
				'label' => esc_html__( 'Fancy delay', 'codevz' ),
				'type' => $free ? 'codevz_pro' : Controls_Manager::NUMBER,
				'min' => 100,
				'max' => 3000,
				'step' => 100,
	...
	public function render() {
		...
		<div>
			<div<?php echo Codevz_Plus::classes( [], $classes ) . ( $settings['fancy_speed'] ? ' data-fancy-speed="' . $settings['fancy_speed'] . '"' : '' ) . ( $settings['fancy_delay'] ? ' data-fancy-delay="' . $settings['fancy_delay'] . '"' : '' ); ?>><?php echo do_shortcode( $out_content ); ?></div>
		</div>
