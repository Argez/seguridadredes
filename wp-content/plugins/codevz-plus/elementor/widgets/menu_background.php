...
class Xtra_Elementor_Widget_menu_background extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu Background', 'codevz' );
	}
	...
	public function register_controls() {
		...
		$this->add_control(
			'first_item',
			[
				'label' 	=> esc_html__( 'Activate first item', 'codevz' ),
	...
	public function render() {
		...
		// Out
		echo '<div' . Codevz_Plus::classes( [], $classes ) . '><div class="xtra-menu-background-items">' . do_shortcode( $children ) . '<div class="xtra-menu-background-glass"></div></div></div>';
