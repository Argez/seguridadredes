		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'cz_split_box_right cz_split_box_q'  => esc_html__( 'Right one third', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'cz_split_box_left cz_split_box_q'  => esc_html__( 'Left one third', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				],
				'condition' => [
					'type' => '2',
				]
