...
class Xtra_Elementor_Widget_posts extends Widget_Base {
	...
	public function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'cz_grid_1_no_desc' => esc_html__( 'Icon and Title on hover', 'codevz' ),
					'cz_grid_1_yes_all' => esc_html__( 'Icon, Title and Meta on hover', 'codevz' ),
					'cz_grid_1_no_icon cz_grid_1_no_desc' => esc_html__( 'Title on hover', 'codevz' ),
					'cz_grid_1_no_icon' => esc_html__( 'Title and Meta on hover', 'codevz' ),
					'cz_grid_1_no_icon cz_grid_1_has_excerpt cz_grid_1_no_desc' => esc_html__( 'Title and Excerpt on hover', 'codevz' ),
					'cz_grid_1_no_icon cz_grid_1_has_excerpt' => esc_html__( 'Title, Meta and Excerpt on hover', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_no_hover' => esc_html__( 'No hover details, Title and Meta after Image', 'codevz' ),
					'cz_grid_1_title_sub_after' => esc_html__( 'Icon on hover, Title and Meta after Image', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_has_excerpt' => esc_html__( 'Icon on hover, Title, Meta and Excerpt after Image', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_no_icon' => esc_html__( 'No Icon, Title, Meta and Excerpt after Image', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_subtitle_on_img' => esc_html__( 'Meta on image, Title after image', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_subtitle_on_img' => esc_html__( 'Meta on image, Title and Excerpt after image', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_no_image' => esc_html__( 'No image, Title and Meta', 'codevz' ),
					'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_no_image' => esc_html__( 'No image, Title, Meta and Excerpt', 'codevz' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			'sk_content',
			[
				'label' 	=> esc_html__( 'Outer content', 'codevz' ),
				'type' 		=> 'stylekit',
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'author_full_date' => esc_html__( 'Avatar, Author and Date', 'codevz' ),
					'author_icon_date' => esc_html__( 'Icon, Author and Date', 'codevz' ),
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' 	=> esc_html__( 'Filter and Search', 'codevz' )
			]
		);
		...
		$this->add_control(
			'smart_details',
			[
				'label' => esc_html__( 'Smart details?', 'codevz' ),
				'type' => $free ? 'codevz_pro' : Controls_Manager::SWITCHER 
			]
		);
	...
	public function render() {
		...
		if ( ! $get_posts ) {
			$get_posts = '<div class="cz_grid_item">' . esc_html__( 'Not found any posts in this category.', 'codevz' ) . '</div>';
		}
