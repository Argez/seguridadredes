		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style6' => esc_html__( 'Style', 'codevz' ) . ' 6' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style7' => esc_html__( 'Style', 'codevz' ) . ' 7' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style8' => esc_html__( 'Style', 'codevz' ) . ' 8' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style9' => esc_html__( 'Style', 'codevz' ) . ' 9' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style10' => esc_html__( 'Style', 'codevz' ) . ' 10' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style11' => esc_html__( 'Style', 'codevz' ) . ' 11' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style12' => esc_html__( 'Style', 'codevz' ) . ' 12' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style13' => esc_html__( 'Style', 'codevz' ) . ' 13' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style14' => esc_html__( 'Style', 'codevz' ) . ' 14' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style15' => esc_html__( 'Style', 'codevz' ) . ' 15' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style16' => esc_html__( 'Style', 'codevz' ) . ' 16' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style17' => esc_html__( 'Style', 'codevz' ) . ' 17' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style18' => esc_html__( 'Style', 'codevz' ) . ' 18' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style19' => esc_html__( 'Style', 'codevz' ) . ' 19' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style20' => esc_html__( 'Style', 'codevz' ) . ' 20' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style21' => esc_html__( 'Style', 'codevz' ) . ' 21' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'style22' => esc_html__( 'Style', 'codevz' ) . ' 22' . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				],
			]
		);
