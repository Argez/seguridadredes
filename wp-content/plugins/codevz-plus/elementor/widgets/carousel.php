		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'dots_vtl' => esc_html__( 'Vertical top left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'dots_vml' => esc_html__( 'Vertical middle left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'dots_vbl' => esc_html__( 'Vertical bottom left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'dots_vtr' => esc_html__( 'Vertical top right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'dots_vmr' => esc_html__( 'Vertical middle rigth', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'dots_vbr' => esc_html__( 'Vertical bottom right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' )
				],
			]
		);
