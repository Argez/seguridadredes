...
class Xtra_Elementor_Widget_counter extends Widget_Base {
	...
	public function register_controls() {
		...
		$this->add_control(
			'currency',
			[
				'label' 	=> esc_html__( 'Currency','codevz' ),
		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'tal cz_2rows' 	=> esc_html__( 'Block | Left', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'tac cz_2rows' 	=> esc_html__( 'Block | Center', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'tar cz_2rows' 	=> esc_html__( 'Block | Right', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				],
			]
		);
