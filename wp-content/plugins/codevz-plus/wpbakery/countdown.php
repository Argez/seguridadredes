		...
		$settings = array(
			...
			'params'		=> array(
				...
				array(
					...
					'value'			=> esc_html__("Minute", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					"param_name"  	=> "minute"
				),
				array(
					...
					'value'			=> esc_html__("Second", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					"param_name"  	=> "second"
				),
				array(
				...
				array(
					...
					'value'			=> esc_html__('This event has been expired', 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					"param_name"  	=> "expire",
					'dependency'	=> array(
						'element'		=> 'type',
